...
class Spinner extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { size, type, color, speed } = _a, others = __rest(_a, ["size", "type", "color", "speed"]);
        const containerStyle = { width: `${size}px`, height: `${type === "bubbles" ? size / 1.5 : size}px` };
        return (React.createElement(Div, Object.assign({}, containerStyle, { display: "inline-block", overflow: "hidden", className: `${this.name} ${this.name}--${this.props.type}` }),
