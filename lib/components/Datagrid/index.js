...
var DataTable = function (_React$Component) {
    ...
    _createClass(DataTable, [{
        ...
        value: function render() {
            ...
            return React.createElement("table", { className: className, style: style }, header, sortable ? React.createElement(Sortable, Object.assign({ tag: "tbody" }, sortableProps), rows) : React.createElement("tbody", null, rows));
        }
    }]);
