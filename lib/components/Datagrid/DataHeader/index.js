...
class DataHeader extends React.PureComponent {
    ...
    renderBulkActions() {
        return this.props.actions.map(obj => {
            return (React.createElement(Button, { className: "m-bulk", onClick: obj.action, key: obj.type, icon: obj.icon, color: "nocolor", style: { margin: "0 2px" }, size: "small" }));
        });
    }
    render() {
            ...
            React.createElement(CssHeader, { className: "m-row", selected: selectedRows && selectedRows.length > 0, s: style },
                ...
                selectedRows && selectedRows.length > 0 ?
                    React.createElement(DataCell, { type: "header" },
                        React.createElement(Div, { className: `m-actions`, textAlign: "center", verticalAlign: "bottom" },
