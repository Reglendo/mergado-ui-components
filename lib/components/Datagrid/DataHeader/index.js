...
class DataHeader extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("thead", null,
            React.createElement(Header, { className: `${this.name} ${this.name}--header ${addClass} ${className}`, selected: selectedRows && selectedRows.length > 0, style: style },
                actions.length > 0 &&
