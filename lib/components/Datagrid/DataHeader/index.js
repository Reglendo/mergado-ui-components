...
var DataHeader = function (_React$Component) {
    ...
    _createClass(DataHeader, [{
        ...
        value: function render() {
            ...
            return React.createElement("thead", null, React.createElement("tr", { className: this.name + " " + this.name + "--header " + addClass, style: style }, actions.length > 0 && React.createElement(DataCell_1.default, { type: "header", style: { width: "1%" } }, React.createElement(Checkbox_1.default, { input: { onChange: this.props.handleSelectAll, checked: this.props.selectedAll } })), this.props.children));
        }
    }]);
