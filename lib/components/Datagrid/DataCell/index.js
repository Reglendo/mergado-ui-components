...
class DataCell extends React.Component {
    ...
    render() {
        ...
        return (type === "header")
            ?
                React.createElement(Th, Object.assign({}, domOnlyProps(this.props), { className: `${this.name} ${this.name}--header ${addClass}`, style: style, onClick: onClick }), this.props.children)
            :
                React.createElement(Td, Object.assign({}, domOnlyProps(this.props), { className: `${this.name} ${addClass}`, style: style, onClick: onClick }), this.props.children);
    }
}
