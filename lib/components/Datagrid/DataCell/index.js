...
class DataCell extends React.PureComponent {
    ...
    render() {
        ...
        return (type === "header")
            ?
                React.createElement(Th, Object.assign({}, domOnlyProps(props), { className: `${this.name} ${className} ${this.name}--header ${addClass}`, s: style, onClick: onClick }), this.props.children)
            :
                React.createElement(Td, Object.assign({}, domOnlyProps(props), { className: `${this.name} ${addClass} ${className} `, s: style, onClick: onClick }), this.props.children);
    }
}
