...
class DataCell extends React.PureComponent {
    ...
    render() {
        ...
        return (type === "header")
            ?
                React.createElement(Th, Object.assign({}, props, { className: `${this.name} m-header ${className}`, s: style, onClick: onClick }), this.props.children)
            :
                React.createElement(Td, Object.assign({}, props, { className: `${this.name} ${className}`, s: style, onClick: onClick }), this.props.children);
    }
}
