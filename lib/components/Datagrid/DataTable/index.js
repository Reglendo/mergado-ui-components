...
class DataTable extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: `${this.name} ${className}` },
            ...
            React.createElement(Table, Object.assign({ className: `${this.name}__table ${addClass}`, style: style }, domOnlyProps(this.props)), this.props.children && this.renderChildren(this.props.children))));
    }
}
