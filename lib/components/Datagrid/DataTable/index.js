...
var Actions = styled_components_1.default.div(_templateObject6);
var ActionsIcons = styled_components_1.default.div(_templateObject7);
/* </style> */
...
var DataTable = function (_React$Component) {
    ...
    _createClass(DataTable, [{
        ...
        value: function renderBulkActionbar() {
            ...
            return React.createElement(Actions, { className: this.name + "__actions_bar" }, React.createElement(Input_1.InputLabel, { name: "actionbar" }, labels.actionsBar), React.createElement(ActionsIcons, { className: this.name + "__actions_icons" }, this.renderBulkActions()));
        }
    }, {
        ...
        value: function render() {
            ...
            return React.createElement(Wrapper, { className: "" + this.name }, React.createElement("div", { style: { whiteSpace: "nowrap" } }, this.props.bulkActions.length > 0 && this.renderBulkActionbar(), this.props.filters.length > 0 && this.renderFiltersBar()), React.createElement(Table, Object.assign({ className: className, style: style }, dom_only_props_1.default(this.props)), this.props.children && this.renderChildren(this.props.children)));
        }
    }]);
