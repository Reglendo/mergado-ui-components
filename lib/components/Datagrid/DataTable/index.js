...
class DataTable extends React.PureComponent {
    ...
    renderButtons() {
        return this.props.buttons.map(obj => {
            return React.createElement(Div, { textAlign: "right", verticalAlign: "bottom" }, obj);
        });
    }
    renderFilters() {
    ...
    render() {
        ...
        return (React.createElement(Div, { className: `${this.name} ${className}` },
            React.createElement(Div, { whiteSpace: "nowrap" }, this.props.filters.length > 0 && this.renderFiltersBar()),
            React.createElement(Table, Object.assign({ className: `${this.name}__table ${addClass}`, s: style }, domOnlyProps(props)), this.props.children && this.renderChildren(this.props.children))));
    }
}
