...
var DataBody_1 = require("../DataBody");
        ...
        value: function renderChildren() {
            ...
            return children.map(function (obj) {
                if (obj.type.name === "DataHeader") {
                    return React.createElement(DataHeader_1.default, Object.assign({}, obj.props, { actions: _this2.props.bulkActions, checkAll: _this2.toggleCheckedAll.bind(_this2), checkedAll: _this2.state.checkedAll, labels: _this2.props.labels }));
                }
                if (obj.type.name === "DataBody") {
                    return React.createElement(DataBody_1.default, Object.assign({}, obj.props, { inputRef: function inputRef(el) {
                            return _this2.inputElement = el;
                        }, actions: _this2.props.bulkActions, labels: _this2.props.labels, checkedAll: _this2.state.checkedAll }));
                }
            });
        }
    }, {
