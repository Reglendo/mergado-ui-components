...
var DataTable = function (_React$Component) {
    ...
    _createClass(DataTable, [{
        ...
        value: function renderBulkActionbar() {
            ...
            return React.createElement(Actions, { className: this.name + "__actions_bar" }, React.createElement(ActionsIcons, { className: this.name + "__actions_icons" }, this.renderBulkActions()));
        }
    }, {
