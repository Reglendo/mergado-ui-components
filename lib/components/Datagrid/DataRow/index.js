...
var DataRow = function (_React$Component) {
    ...
    _createClass(DataRow, [{
        ...
        value: function render() {
            ...
            return React.createElement("tr", { className: this.name + " " + (inactive && this.name + "--inactive") + " " + addClass, key: unique_id_1.default(), "data-id": dataId, style: style }, actions.length > 0 && React.createElement(DataCell_1.default, null, React.createElement(Checkbox_1.default, { checked: this.state.checked, onChange: function onChange(evt) {
