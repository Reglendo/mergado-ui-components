...
var PopupHint = function (_React$Component) {
    ...
    _createClass(PopupHint, [{
        ...
        value: function render() {
            ...
            var hint = React.createElement(Bubble_1.default, null, React.createElement("div", { ref: "hint", className: this.name + "__bubble", style: style, tabIndex: 0, onBlur: this.collapse }, React.createElement("div", { className: this.name + "__innerwrapper" }, React.createElement("div", { className: this.name + "__border" }, React.createElement("div", { className: this.name + "__content" }, this.props.content)), React.createElement("span", { ref: "arrow", className: this.name + "__arrow" }))));
            return React.createElement("div", { className: this.name, style: { display: 'inline-block' } }, React.createElement("div", { ref: "button", className: this.name + "__trigger " + (this.state.expanded ? "active" : ""), onMouseDown: this.state.expanded ? function () {} : this.expand }, this.props.icon ? this.props.icon : null), hint);
        }
    }]);
