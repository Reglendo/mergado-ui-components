...
var PopupHint = function (_React$Component) {
    ...
    _createClass(PopupHint, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: this.name, style: Object.assign({}, this.props.style, { display: "inline-block" }) }, React.createElement("div", { ref: "button", className: this.name + "__trigger " + (this.state.expanded ? "active" : ""), onMouseDown: this.state.expanded ? function () {} : this.expand, onClick: function onClick(e) {
                    e.preventDefault();
                    e.stopPropagation();
