        ...
        const hint = (React.createElement(Bubble, null,
            React.createElement("div", { ref: "hint", className: `${this.name}__bubble`, style: style, tabIndex: 0, onBlur: this.state.expanded ? this.collapse : () => { } },
                React.createElement(Div, { position: "relative", padding: "0 0 10px 0", className: `${this.name}__innerwrapper` },
                    React.createElement(HintContent, { hint: this.props.hint, className: `${this.name}__content` }, this.props.children),
                    React.createElement("div", { ref: "arrow", style: {
                        ...
                        React.createElement(HintArrow, { hint: this.props.hint, className: `${this.name}__arrow` }))))));
        return (React.createElement(Div, { cursor: this.props.hint || this.props.help ? "help" : (this.props.hover ? "normal" : "pointer"), verticalAlign: "text-bottom", display: "inline-block", className: this.name, style: Object.assign({}, this.props.style) },
            React.createElement("div", { ref: "button", className: `${this.name}__trigger ${this.state.expanded ? "active" : ""}`, onMouseDown: this.state.expanded ? () => { } : this.expand, onMouseEnter: (!this.props.hover && !this.props.hover) || this.state.expanded ? () => { } : this.expand, onMouseLeave: (this.props.hover || this.props.hint) && this.state.expanded ? this.collapse : () => { }, onClick: (e) => {
                    e.preventDefault();
                    e.stopPropagation();
                } },
