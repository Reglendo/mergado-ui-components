...
class PopupHint extends React.Component {
    ...
    render() {
        ...
        const hint = (React.createElement(Bubble, null,
            React.createElement(HintWrapper, { innerRef: (o) => { this.refs.hint = o; }, className: `${this.name}__bubble`, style: style, tabIndex: 0, onBlur: this.state.expanded ? this.collapse : () => { } },
        ...
        return (React.createElement(Div, { cursor: this.props.hover ? "normal" : "pointer", verticalAlign: "text-bottom", display: "inline-block", className: this.name, style: Object.assign({}, this.props.style) },
