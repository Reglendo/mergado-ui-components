...
class PopupHint extends React.Component {
    ...
    render() {
        ...
        const hint = (React.createElement(Bubble, null,
            React.createElement("div", { ref: "hint", className: `muk-bubble`, style: style, tabIndex: 0, onBlur: this.state.expanded ? this.collapse : () => { } },
                React.createElement(Div, { position: "relative", padding: "0 0 10px 0", className: `m-innerwrapper` },
                    React.createElement(HintContent, { hover: this.props.hover, className: `m-content`, id: `${this.name}__content` }, this.props.children),
                    React.createElement(Div, Object.assign({ ref: "arrow", className: "m-arrow-wrapper" }, {
                        width: "12px",
                        height: "12px",
                        position: "absolute",
                        ...
                        React.createElement(HintArrow, { hover: this.props.hover, className: `m-arrow` }))))));
        return (React.createElement(Div, { className: `${this.name} ${this.props.className || ""}`, cursor: "help", verticalAlign: "text-bottom", display: "inline-block", style: Object.assign({}, this.props.style) },
            React.createElement("div", { ref: "button", className: `m-trigger ${this.state.expanded ? "m-active" : ""}`, onMouseDown: this.state.expanded ? () => { } : this.expand, onMouseEnter: !this.props.hover || this.state.expanded ? () => { } : this.expand, onMouseLeave: this.props.hover && this.state.expanded ? this.collapse : () => { }, onClick: (e) => {
                    e.preventDefault();
                    e.stopPropagation();
                } },
