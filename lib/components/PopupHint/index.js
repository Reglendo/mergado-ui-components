...
class PopupHint extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Div, { cursor: this.props.hover ? "normal" : "pointer", verticalAlign: "middle", display: "inline-block", className: this.name, style: Object.assign({}, this.props.style) },
