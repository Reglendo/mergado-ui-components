...
var Icon = function (_React$Component) {
    ...
    _createClass(Icon, [{
        ...
        value: function render() {
            ...
            return React.createElement("span", { className: className, style: this.props.style, title: this.props.title }, React.createElement("svg", { className: this.name + "__image", preserveAspectRatio: "xMidYMid meet", fill: "currentColor", height: this.props.size, width: this.props.size, viewBox: this.props.viewBox }, icon), this.props.text ? React.createElement("span", { className: this.name + "__text" }, this.props.text) : null);
        }
    }]);
