    ...
    _createClass(IconFinder, [{
        ...
        value: function renderIcons() {
            ...
            return found.map(function (obj) {
                return React.createElement("span", { className: _this2.name + "__icon", title: obj, tabIndex: 1 }, React.createElement(Icon_1.default, { name: "" + obj, size: 30, text: "import " + obj + " from \"mergado-ui-icons/lib/icons/" + obj + "\"", style: { display: 'inline-block', margin: '5px' } }));
            });
        }
    }, {
        key: "render",
