...
class DatePicker extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(StyledField, { labels: labels },
            React.createElement(ReactDatePicker, Object.assign({ "aria-invalid": isInvalid ? 1 : 0, placeholder: this.state.startDate ? dayjs(this.state.startDate).format(FORMAT) : FORMAT, onDayChange: this.handleChanged, dayPickerProps: Object.assign({ firstDayOfWeek: 1, months: this.locale.MONTHS, weekdaysLong: this.locale.WEEKDAYS_LONG, weekdaysShort: this.locale.WEEKDAYS_SHORT, selectedDays: dayjs(this.state.startDate).toDate(), month: dayjs(this.state.startDate).toDate() }, props), parseDate: (a) => {
