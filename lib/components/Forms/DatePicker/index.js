...
var DatePicker = function (_React$Component) {
    ...
    _createClass(DatePicker, [{
        ...
        value: function render() {
            ...
            return React.createElement(Input_1.Input, Object.assign({ name: this.name }, props), React.createElement(Input_1.InputError, Object.assign({}, props)), React.createElement(Input_1.InputLabel, { name: this.name }, labels.main), React.createElement("div", { className: this.name + "__picker" }, picker));
        }
    }]);
