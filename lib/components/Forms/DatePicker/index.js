...
var DatePicker = function (_React$Component) {
    ...
    _createClass(DatePicker, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: this.name + " " + this.form + "__group " + (meta.invalid && (meta.dirty || meta.touched) ? this.form + "__group--invalid" : ''), style: this.props.style }, this.renderInvalid(), React.createElement("span", { className: this.name + "__label " + this.form + "__label" }, labels.main), React.createElement("div", { className: this.name + "__picker" }, picker));
        }
    }]);
