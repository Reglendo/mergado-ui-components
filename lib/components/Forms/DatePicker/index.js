...
class DatePicker extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(StyledField, null,
            React.createElement(ReactDatePicker, Object.assign({ "aria-invalid": isInvalid ? 1 : 0, placeholder: FORMAT, selectedDays: this.state.startDate, onDayChange: this.handleChanged, locale: "cs", dayPickerProps: Object.assign({ firstDayOfWeek: 1, months: this.locale.MONTHS, weekdaysLong: this.locale.WEEKDAYS_LONG, weekdaysShort: this.locale.WEEKDAYS_SHORT }, props), parseDate: (a) => {
                    const parsed = a.split(" ").map(o => parseInt(o, 10));
                    return new Date(parsed[2], parsed[1] - 1, parsed[0]);
                }, formatDate: (a, b) => dayjs(a).format(b), format: FORMAT }, input.props)),
            React.createElement("style", null, factoryStyle)));
    }
}
DatePicker.defaultProps = Object.assign({ locale: "cs" }, defaultFieldProps);
