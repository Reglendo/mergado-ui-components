        ...
        showInput &&
            React.createElement("span", null, singleChoice ?
                React.createElement(Radio, { items: [
                        ...
                        onChange: onClick,
                    }, name: name, key: "input", style: { display: showInput ? "inline-block" : "none", pointerEvents: "none" } })
                :
                    React.createElement(Checkbox, { name: name + "." + props.value, key: "input", style: { display: showInput ? "inline-block" : "none", pointerEvents: "none", paddingRight: "5px" } })),
