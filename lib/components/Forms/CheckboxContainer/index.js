...
export class CheckboxContainer extends React.Component {
    ...
    renderFilter() {
        return (React.createElement(TextInput, { className: `${this.name}__filter_input`, type: "search", onClear: () => this.setState({ filter: "" }), style: { marginBottom: "5px" }, input: { value: this.state.filter,
