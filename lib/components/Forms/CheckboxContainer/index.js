...
var CheckboxContainer = function (_MUK$InputComponent) {
    ...
    _createClass(CheckboxContainer, [{
        key: "sortOptions",
        value: function sortOptions(props) {
            if (!props.meta.initial) {
                return;
            }
            var queries = props.meta.initial;
            return function (a, b) {
        ...
        value: function renderOptions(options) {
            ...
            return options.filter(function (option) {
                ...
                var item = React.createElement(item_1.default, { name: _this2.name, active: index >= 0, disabled: option.disabled, onClick: handler, singleChoice: _this2.props.singleChoice, checked: queries.indexOf(option.id) > 0, showRadio: _this2.props.showRadio, option: option, labels: _this2.props.labels, key: option.id });
                if (option.link) {
