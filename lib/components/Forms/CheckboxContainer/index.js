...
var CheckboxContainer = function (_React$Component) {
    ...
    _createClass(CheckboxContainer, [{
        ...
        value: function render() {
            ...
            return React.createElement(Input_1.Input, Object.assign({ name: this.name }, props), React.createElement(Input_1.InputLabel, { name: this.name }, this.props.showLabel ? this.props.labels.main : React.createElement("h3", { className: this.name + "__header", title: this.props.meta.invalid ? this.props.labels.invalid : "" }, this.props.labels.main)), React.createElement(Input_1.InputError, Object.assign({}, props)), React.createElement("div", { className: this.name + "__queries" }, this.props.withoutFilter === false ? React.createElement("div", { className: this.name + "__filter" }, React.createElement("input", { className: this.name + "__filter_input " + this.form + "__input--text", type: "text", id: "filter", name: "filter", value: this.state.filter, placeholder: this.props.labels.placeholder, onChange: function onChange(evt) {
