...
class Checkbox extends React.Component {
    ...
    renderLabel() {
        ...
        return React.createElement(Label, { className: `${isInvalid ? `m-invalid` : ""}` },
            React.createElement(Div, { className: "m-element-wrapper", position: "relative", display: "inline-block", verticalAlign: "middle" },
