...
var Checkbox = function (_MUK$InputComponent) {
    ...
    _createClass(Checkbox, [{
        ...
        value: function renderLabel(className, props) {
            ...
            return React.createElement("span", null, React.createElement("input", Object.assign({}, input, props, { type: "checkbox", className: this.name + "__item " + className, defaultChecked: input ? !!input.value : false })), labels ? " " + labels.main : "");
        }
    }]);
