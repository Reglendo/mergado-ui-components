...
var Checkbox = function (_React$Component) {
    ...
    _createClass(Checkbox, [{
        ...
        value: function renderLabel() {
            ...
            return React.createElement("div", { className: "" + (isInvalid ? config_1.form + "__group--invalid" : "") }, React.createElement("input", Object.assign({ checked: input.value }, input, { type: "checkbox", className: this.name + "__item " + (input.className ? input.className : "") })), label && " ", label);
        }
    }, {
        key: "render",
