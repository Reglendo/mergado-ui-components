...
const LabelComponent = ({ children, bigLabel, className = "" }) => {
    ...
    return (React.createElement("label", { className: `${form}__label ${className}` }, bigLabel ? React.createElement(BigLabel, null, children) : children));
};
...
const FieldComponent = (props) => {
    ...
    return (React.createElement(Div, Object.assign({}, props, { className: `${props.name ? props.name : ""} ${props.className || ""} ${props.disabled ? props.name + `--disabled` : ""} ${props.required ? props.name + `--required` : ""} ${form}__group`, title: props.labels.title }, props.style),
