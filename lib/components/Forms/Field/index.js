...
const FieldComponent = (props) => {
    ...
    return (React.createElement(Div, Object.assign({}, others, { className: `${form}-group ${props.name ? props.name : ""} ${props.disabled ? "disabled" : ""} ${props.required ? "required" : ""}  ${props.className || ""}`, title: props.labels.title }, props.style),
