...
const FieldComponent = (props) => {
    ...
    return (React.createElement(Div, Object.assign({ className: `${form}-group ${props.name ? "m-field-" + props.name : ""} ${props.disabled ? "disabled" : ""} ${props.required ? "required" : ""}  ${props.className || ""}`, title: props.labels.title }, style),
        React.createElement(FieldError, { meta: meta, className: `${form}__validation` }),
