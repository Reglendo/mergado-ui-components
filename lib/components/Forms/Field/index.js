...
var BigLabel = styled_components_1.default.h3(_templateObject);
var LabelComponent = function LabelComponent(_ref) {
    var children = _ref.children,
        name = _ref.name,
        bigLabel = _ref.bigLabel;
...
exports.FieldLabel = styled_components_1.default(LabelComponent)(_templateObject2);
...
exports.FieldError = styled_components_1.default(FieldErrorComponent)(_templateObject3, style.RED);
var FieldComponent = function FieldComponent(props) {
    ...
    return React.createElement("div", Object.assign({}, dom_only_props_1.default(props), { className: (props.name ? props.name : "") + "\n                        " + (props.className ? props.className : "") + "\n                        " + (props.disabled ? props.name + "--disabled" : "") + "\n                        " + (props.required ? props.name + "--required" : "") + "\n                        " + config_1.form + "__group\n                        ", title: props.labels.title, style: props.style }), React.createElement(exports.FieldError, Object.assign({}, props, { className: config_1.form + "__validation}" })), React.createElement(exports.FieldLabel, { name: props.name, bigLabel: group.bigLabel }, props.label ? props.label : others.label ? others.label : labels.main), React.createElement("div", { className: "                    " + (isInvalid ? config_1.form + "__group--invalid" : "") + "                " }, props.children));
};
FieldComponent.defaultProps = exports.defaultFieldProps;
exports.Field = styled_components_1.default(FieldComponent)(_templateObject4, config_1.form, function (props) {
