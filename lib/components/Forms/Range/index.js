        ...
        return (React.createElement(StyledField, Object.assign({}, props, { name: this.name }),
            React.createElement(Grid, { cols: "100px auto" },
                React.createElement(GridCell, null,
                    React.createElement(TextInput, { name: props.name, type: "number", max: this.props.max, min: this.props.min, step: this.props.step, value: this.props.value })),
                React.createElement(GridCell, { style: { padding: "5px 0 5px 10px" } },
                    React.createElement(Element, Object.assign({}, (!props.name && input), { name: props.name, className: `${this.name}__item
                                        ${form}__input--text ${form}__input--range`, type: "range", max: this.props.max, min: this.props.min, step: this.props.step }))))));
    }
}
