...
var Button = function (_MUK$InputComponent) {
    ...
    _createClass(Button, [{
        ...
        value: function renderHref(className, props) {
            ...
            return React.createElement("a", Object.assign({}, props, { href: link, className: this.name + "__item", title: labels.title }), icon, labels.main);
        }
    }, {
        key: "renderButton",
        value: function renderButton(className, props) {
            ...
            return React.createElement("button", Object.assign({}, props, { className: this.name + "__item " + (className ? className : ""), title: labels.title }), icon, labels.main);
        }
    }, {
        key: "renderLink",
        ...
        value: function renderVoid(className, props) {
            ...
            return React.createElement("span", Object.assign({}, props, { className: this.name + "__item " + (className ? className : ""), title: labels.title }), icon, labels.main);
        }
    }, {
        key: "renderLabel",
