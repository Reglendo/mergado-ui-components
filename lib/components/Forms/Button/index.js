...
var Button = function (_React$Component) {
    ...
    _createClass(Button, [{
        ...
        value: function renderButton() {
            ...
            return React.createElement("button", { className: this.name + "__item", onClick: onClick, name: input.name, title: labels.title }, icon, labels.main);
        }
    }, {
        key: "renderLink",
