...
var Button = function (_MUK$InputComponent) {
    ...
    _createClass(Button, [{
        ...
        value: function renderHref(className, props) {
            ...
            delete props.labels;
            delete props.icon;
            return React.createElement("a", Object.assign({}, input, { href: link, className: this.name + "__item", title: labels.title }), icon, labels.main);
        }
    }, {
        key: "renderButton",
        value: function renderButton(className, props) {
            ...
            delete props.labels;
            delete props.icon;
            return React.createElement("button", Object.assign({}, input, { className: this.name + "__item " + (className ? className : ""), title: labels.title }), icon, labels.main);
        }
    }, {
        key: "renderLink",
        value: function renderLink(className, props) {
            ...
            delete props.labels;
            delete props.icon;
            return React.createElement(react_router_1.Link, { to: link, className: this.name + "__item " + (className ? className : ""), title: labels.title }, icon, labels.main);
        }
    }, {
        key: "renderSubmit",
        ...
        value: function renderVoid(className, props) {
            ...
            delete props.labels;
            delete props.icon;
            return React.createElement("span", Object.assign({}, input, { className: this.name + "__item " + (className ? className : ""), title: labels.title }), icon, labels.main);
        }
    }, {
        key: "renderLabel",
