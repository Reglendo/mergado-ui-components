...
export class Button extends React.Component {
    ...
    render() {
        ...
        if (props.type !== "submit") {
            return React.createElement(UniversalButton, Object.assign({}, this.props, { s: style, name: this.name }));
        }
        return (React.createElement(StyledField, Object.assign({ className: `${this.name}--${props.color}
            ...
            React.createElement(UniversalButton, Object.assign({}, this.props, { s: style, name: this.name }))));
    }
}
