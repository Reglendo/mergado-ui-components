...
var colorize = function colorize() {
    return function (props) {
        ...
        var dark = polished_1.darken(0.05, color);
        var darker = polished_1.darken(0.1, color);
...
var Href = function Href(_a) {
    ...
    return React.createElement("a", Object.assign({}, dom_only_props_1.default(props), { href: link, className: name + "__item " + (className ? className : ""), title: title }), icon, label);
};
var Button = function Button(_a) {
    ...
    return React.createElement("button", Object.assign({}, input, dom_only_props_1.default(props), { className: name + "__item " + (className ? className : ""), title: title }), icon, label);
};
var Link = function Link(_a) {
    ...
    return React.createElement(react_router_1.Link, Object.assign({}, dom_only_props_1.default(props), { to: link, className: name + "__item " + (className ? className : ""), title: title }), icon, label);
};
...
var Void = function Void(_a) {
    ...
    return React.createElement("span", Object.assign({}, dom_only_props_1.default(props), { className: name + "__item " + (className ? className : ""), title: title }), icon, label);
};
