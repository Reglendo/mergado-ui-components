...
const styled_theme_1 = require("../../../styled/styled-theme");
...
const colorize = () => (props) => {
    if (props.color === "nocolor") {
        return styled_components_1.css `
            ...
            padding: 0;
            border: none;
            color: ${styled_theme_1.default.blue};
            &:active,&:focus {
              border: none;
              outline: none;
            ...
            path {
                fill: ${styled_theme_1.default.blue};
            }
        `;
    }
    const color = styled_theme_1.default[props.color === "gray" ? "grey" : props.color];
...
const styling = styled_components_1.css `
    ...
    border-radius: ${styled_theme_1.default.button_radius};
    display: inline-block;
    cursor: pointer;
    text-align: center;
    text-decoration: none;
    text-transform: ${styled_theme_1.default.button_text_transform};
    font-size: ${styled_theme_1.default.button_text_size};
    font-weight: ${styled_theme_1.default.button_text_weight};
    user-select: none;
    padding: 0px 20px;
    height: 42px;
    line-height: 39px;
