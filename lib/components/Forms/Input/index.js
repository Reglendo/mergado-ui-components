...
exports.Input = function (_a) {
    ...
    return React.createElement("div", { className: props.name + " " + (props.disabled ? props.name + "--disabled" : "") + " " + (props.required ? props.name + "--required" : "") + " " + (addProps.className ? addProps.className : "") + " " + config_1.form + "__group " + (props.meta.invalid && (props.meta.dirty || props.meta.touched) ? config_1.form + "__group--invalid" : ""), title: props.labels.title, style: props.style }, props.children);
};
