...
var Textarea = function (_React$Component) {
    ...
    _createClass(Textarea, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: this.name + " " + this.form + "__group\n                            " + (meta.invalid && (meta.dirty || meta.touched) ? this.form + "__group--invalid" : ""), title: this.props.labels.title, style: this.props.style }, this.renderInvalid(), React.createElement("label", { className: this.name + "__label " + this.form + "__label", htmlFor: inputId }, this.props.labels.main), React.createElement("textarea", Object.assign({ className: this.name + "__input " + this.form + "__input--text " + this.form + "__input--textarea\n                                " + (meta.invalid && (meta.dirty || meta.touched) ? "invalid" : ""), id: id ? id : inputId, placeholder: this.props.labels.placeholder }, input, addProps), input.value));
        }
    }]);
