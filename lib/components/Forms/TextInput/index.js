    ...
    render() {
        ...
        return (React.createElement(Field, Object.assign({}, props, { className: `${this.name} ${className || ""}`, s: style, name: props.name }),
            React.createElement(Div, { className: "m-textinput-wrapper", position: "relative" },
                React.createElement(Element, Object.assign({}, elProps, (!props.name && inputProps), { placeholder: this.props.labels.placeholder, ref: "input", type: type === "search" || (type === "password" && this.state.passwordVisible)
