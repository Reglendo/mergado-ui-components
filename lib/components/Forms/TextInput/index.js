...
var TextInput = function (_React$Component) {
    ...
    _createClass(TextInput, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: this.name + " " + addClass + " " + this.form + "__group\n                            " + (meta.invalid && (meta.dirty || meta.touched) ? this.form + "__group--invalid" : ""), title: this.props.labels.title, style: this.props.style }, this.renderInvalid(), this.props.labels.main && React.createElement("label", { className: this.name + "__label " + this.form + "__label", htmlFor: inputId }, this.props.labels.main), React.createElement("input", Object.assign({ id: inputId, type: type, placeholder: this.props.labels.placeholder, ref: "input" }, this.props.input, addProps, { className: this.name + "__input " + this.form + "__input--text " + this.form + "__input--" + type + "\n                                " + (meta.invalid && (meta.dirty || meta.touched) ? "invalid" : "") + "\n                                " + (this.props.addProps ? this.props.addProps.addClass : "") })));
        }
    }]);
