    ...
    render() {
        ...
        return (React.createElement(Field, Object.assign({}, props, { name: this.name }),
            React.createElement(Div, { position: "relative" },
                React.createElement(StyledInput, Object.assign({}, props, inputProps, { placeholder: this.props.labels.placeholder, ref: "input", type: type === "search" || (type === "password" && this.state.passwordVisible)
