...
var TextInput = function (_MUK$InputComponent) {
    ...
    _createClass(TextInput, [{
        ...
        value: function renderInput(className, props) {
            ...
            return React.createElement("input", Object.assign({}, input, { placeholder: this.props.labels.placeholder, ref: "input", type: type, className: this.name + "__input " + this.form + "__input--text " + this.form + "__input--" + type + " " + className }));
        }
    }]);
