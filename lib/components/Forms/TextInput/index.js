...
var TextInput = function (_React$Component) {
    ...
    _createClass(TextInput, [{
        ...
        value: function render() {
            ...
            return React.createElement(Input_1.Input, Object.assign({ name: this.name }, props), React.createElement(Input_1.InputError, Object.assign({}, props)), React.createElement(Input_1.InputLabel, { name: this.name }, this.props.labels.main), React.createElement("input", Object.assign({ id: inputId, type: type, placeholder: this.props.labels.placeholder, ref: "input" }, this.props.input, inputProps, { className: this.name + "__input " + this.form + "__input--text " + this.form + "__input--" + type + "\n                                " + (meta.invalid && (meta.dirty || meta.touched) ? "invalid" : "") + "\n                                " + (this.props.addProps ? this.props.addProps.addClass : "") })));
        }
    }]);
