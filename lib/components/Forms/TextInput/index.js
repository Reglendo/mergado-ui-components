...
class TextInput extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Field, Object.assign({}, props, { s: style, name: props.name }),
            React.createElement(Div, { position: "relative" },
                React.createElement(Element, Object.assign({}, props, (!props.name && inputProps), { placeholder: this.props.labels.placeholder, ref: "input", type: type === "search" || (type === "password" && this.state.passwordVisible)
