    ...
    render() {
        ...
        return (React.createElement(Field, Object.assign({}, props, { name: this.name }),
            React.createElement(glamorous.Div, { position: "relative" },
                React.createElement(StyledInput, Object.assign({}, props, inputProps, { placeholder: this.props.labels.placeholder, ref: "input", innerRef: r => (this._inputRef = r), type: type === "search" || (type === "password" && this.state.passwordVisible) ? "text" : props.type, "aria-invalid": isInvalid ? 1 : 0, className: `${this.name}__input \
                                ${form}__input--text \
                                ${form}__input--${type} \
                ...
                type === "search" &&
                    React.createElement(ButtonClose, { icon: React.createElement(IconClose, null), color: "nocolor", size: "tiny", onClick: () => {
