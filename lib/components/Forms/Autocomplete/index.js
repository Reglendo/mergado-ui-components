...
var Autocomplete = function (_React$Component) {
    ...
    _createClass(Autocomplete, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: "" + className }, React.createElement(TextInput_1.default, { ref: "input", type: "search", labels: labels, meta: meta, input: inputProps, addProps: this.props.addProps }), open && this.renderMenu());
        }
    }]);
