...
var Autocomplete = function (_React$Component) {
    ...
    _createClass(Autocomplete, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            if (this.props.items !== nextProps.items || this.state.highlightedIndex >= nextProps.items.length) {
        ...
        value: function render() {
            ...
            var addProps = Object.assign({}, this.props.addProps, { autoComplete: "off" });
            ...
            return React.createElement("div", { className: "" + className }, React.createElement(TextInput_1.default, { ref: "input", type: "search", labels: labels, meta: meta, input: inputProps, addProps: addProps }), open && this.renderMenu());
        }
    }]);
...
Autocomplete.defaultProps = {
    ...
    renderItem: function renderItem(item, highlighted, style) {
