...
class Autocomplete extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { labels, meta, input, shouldItemRender, renderMenu, onMenuVisibilityChange, renderItem, getItemValue } = _a, props = __rest(_a, ["labels", "meta", "input", "shouldItemRender", "renderMenu", "onMenuVisibilityChange", "renderItem", "getItemValue"]);
        ...
        return (React.createElement(Field, { label: "" },
            React.createElement(TextInput, Object.assign({}, props, { id: "autocomplete-input", labels: labels, meta: meta, input: inputProps })),
