...
var Header = styled_components_1.default.h3(_templateObject);
...
var InputComponent = function (_React$Component) {
    ...
    _createClass(InputComponent, [{
        ...
        value: function renderLabel(className, props) {
            ...
            return this.props.group.bigLabel === false ? label : React.createElement(Header, { className: this.form + "__header" }, label);
        }
    }, {
        key: "render",
        value: function render() {
            ...
            var inputProps = dom_only_props_1.default(Object.assign({ id: this.props.meta.form ? this.props.meta.form + "-" + input.name : "" }, others));
