    ...
    render() {
        ...
        return (React.createElement(Field, Object.assign({}, props, { name: this.name }),
            React.createElement(Div, { position: "relative" },
                React.createElement(StyledLightSelect, Object.assign({ closeOnChange: !props.multiple, selectItem: true, placeholder: "- - -", searchEmptyPlaceholder: "", searchPlaceholder: "", clearText: "", searchText: "" }, props, { options: props.options.map(o => {
                        if (o.title) {
