    ...
    render() {
        ...
        return (React.createElement(Field, Object.assign({}, props, { name: this.name }),
            React.createElement(Div, { position: "relative" },
                React.createElement(StyledLightSelect, Object.assign({}, props, (!props.name && input), { closeOnChange: true, options: props.options, selectItem: true, "aria-invalid": isInvalid ? 1 : 0 })),
                React.createElement(IconChevronDown, { size: 10, style: {
