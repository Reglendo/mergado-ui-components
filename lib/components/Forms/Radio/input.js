...
const RadioInput = (_a) => {
    ...
    return React.createElement(Label, { className: `${name}__item ${props.className}`, key: value },
        React.createElement(Element, Object.assign({ name: name }, (name && { value }), { checked: checked, onChange: onChange, type: "radio", className: `${this.name}__item`, style: { display: "none" }, "data-big": bigButtons })),
        React.createElement("span", null,
            React.createElement(StyledInput, null),
            "\u00A0",
            label));
