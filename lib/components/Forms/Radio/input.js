...
const RadioInput = (_a) => {
    ...
    if (bigButtons) {
        return React.createElement(CssBigLabel, { className: `muk-radio ${props.className || ""}`, key: value },
            React.createElement(Element, { name: formName, value: value, type: checkboxes ? "checkbox" : "radio", className: `m-input`, style: { display: "none" }, "data-big": true }),
            React.createElement(Button, { secondary: true, style: { display: "block" }, className: "m-button", type: "void" },
                !hideInput &&
                    React.createElement(Span, { className: "m-input-wrapper", display: "inline-block", verticalAlign: "middle", height: "18px", position: "relative" },
                        checkboxes &&
                            React.createElement(StyledCheckbox, { className: "m-checkbox-input", label: label }),
                        checkboxes &&
                            React.createElement(IconCheck, { className: "m-check", size: 14 }),
                        !checkboxes &&
                            React.createElement(CssCheckbox, { className: "m-radio-input" })),
                React.createElement(Span, { className: "m-label-wrapper", verticalAlign: "middle" }, label)));
    }
    return React.createElement(CssLabel, { className: `muk-radio ${props.className || ""}`, key: value },
        ...
        React.createElement("span", { className: "m-button" },
            React.createElement(CssCheckbox, { className: "m-radio-input" }),
            React.createElement(Span, { className: "m-label-wrapper", verticalAlign: "middle" },
                "\u00A0",
                label)));
};
