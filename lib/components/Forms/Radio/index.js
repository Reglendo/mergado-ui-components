...
class Radio extends React.Component {
    ...
    renderInputs() {
        ...
        return this.props.items.map((obj) => {
            return (React.createElement(RadioInput, { name: this.props.name, label: obj.label, value: obj.value, key: obj.value, checked: obj.value == input.value, onChange: input.onChange, bigButtons: bigButtons, hideInput: hideInput }));
        });
    }
    render() {
