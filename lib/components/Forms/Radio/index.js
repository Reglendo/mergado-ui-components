...
var Radio = function (_MUK$InputComponent) {
    ...
    _createClass(Radio, [{
        ...
        value: function renderLabel(className, props) {
            ...
            return React.createElement("span", null, React.createElement("input", Object.assign({}, input, props, { className: this.name + "__item " + className, type: "radio" })), "\xA0", this.props.labels.main);
        }
    }]);
